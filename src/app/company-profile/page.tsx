              ...
              <div className="flex-grow-1">
                <div className="row">
                  <div className="col-md mb-3 mb-md-0">
                    <h1 className="h2 mb-1">Dropbox <img className="avatar avatar-xs" src="../assets/svg/illustrations/top-vendor.svg" alt="Review rating" data-bs-toggle="tooltip" data-bs-placement="top" title="Claimed profile" /></h1>
                    {/* Rating */}
                  ...
                  <div className="col-md-auto align-self-md-end">
                    <div className="d-grid d-sm-flex gap-2">
                      <a className="btn btn-primary" href="#">54 Open jobs</a>
               ...
               &quot;endPoint&quot;: &quot;#pageHeaderTabEndPoint&quot;
                ...
                &quot;customOffsetTop&quot;: 40
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="#jobs-section">Jobs <span className="badge bg-info rounded-pill ms-1">+9</span></a>
                  </li>
                  <li className="nav-item">
                ...
                <div className="row gx-3">
                  <div className="col-4 col-sm px-2 mb-3 mb-sm-0">
                    ...
                    <a className="media-viewer" href="../assets/img/900x900/img1.jpg" data-fslightbox="jobOverviewGallery">
                      <img className="img-fluid rounded-2" src="../assets/img/900x900/img1.jpg" alt="Image Description" />
                  ...
                  <div className="col-4 col-sm px-2 mb-3 mb-sm-0">
                    ...
                    <a className="media-viewer" href="../assets/img/900x900/img8.jpg" data-fslightbox="jobOverviewGallery">
                      <img className="img-fluid rounded-2" src="../assets/img/900x900/img8.jpg" alt="Image Description" />
                      <span className="media-viewer-container">
                        <span className="media-viewer-icon">
                          <i className="bi-plus media-viewer-icon-inner" />
                        </span>
                  ...
                  <div className="col-4 col-sm px-2 mb-3 mb-sm-0">
                    ...
                    <a className="media-viewer" href="../assets/img/900x900/img7.jpg" data-fslightbox="jobOverviewGallery">
                      <img className="img-fluid rounded-2" src="../assets/img/900x900/img7.jpg" alt="Image Description" />
                      <span className="media-viewer-container">
                        <span className="media-viewer-icon">
                          <i className="bi-plus media-viewer-icon-inner" />
                        </span>
                  ...
                  <div className="col-4 col-sm px-2 mb-3 mb-sm-0">
                    ...
                    <a className="media-viewer" href="../assets/img/900x900/img23.jpg" data-fslightbox="jobOverviewGallery">
                      <img className="img-fluid rounded-2" src="../assets/img/900x900/img23.jpg" alt="Image Description" />
                      <span className="media-viewer-container">
                        <span className="media-viewer-icon">
                          <i className="bi-plus media-viewer-icon-inner" />
                        </span>
                  ...
                  <div className="col-4 col-sm px-2 mb-3 mb-sm-0">
                    ...
                    <a className="media-viewer" href="../assets/img/900x900/img9.jpg" data-fslightbox="jobOverviewGallery">
                      <img className="img-fluid rounded-2" src="../assets/img/900x900/img9.jpg" alt="Image Description" />
                      <span className="media-viewer-container">
            ...
            <div className="col-md-8 mb-7 mb-md-0">
              ...
              <ul className="list-comment mb-7">
                  ...
                  <div className="d-flex mb-3">
                    ...
                    <div className="flex-grow-1 ms-3">
                      ...
                      <div className="d-flex align-items-center mb-3">
                        ...
                        <img className="me-2" src="../assets/svg/illustrations/star.svg" alt="Review rating" width={14} />
                ...
                <li className="list-comment-item">
                  ...
                  <div className="d-flex mb-3">
                    <div className="flex-shrink-0">
                      <img className="avatar avatar-circle" src="../assets/img/160x160/img1.jpg" alt="Image Description" />
                    </div>
                    <div className="flex-grow-1 ms-3">
                      <h5>Brian Ortega</h5>
                      <div className="d-flex align-items-center mb-3">
                ...
                <li className="list-comment-item">
                  ...
                  <div className="d-flex mb-3">
                    <div className="flex-shrink-0">
                      <img className="avatar avatar-circle" src="../assets/img/160x160/img7.jpg" alt="Image Description" />
                    </div>
                    <div className="flex-grow-1 ms-3">
                ...
                <li className="list-comment-item">
                  ...
                  <div className="d-flex mb-3">
                    <div className="flex-shrink-0">
                      <img className="avatar avatar-circle" src="../assets/img/160x160/img6.jpg" alt="Image Description" />
                    </div>
                    <div className="flex-grow-1 ms-3">
                      <h5>Alex Walters</h5>
                      <div className="d-flex align-items-center mb-3">
                ...
                <li className="list-comment-item">
                  ...
                  <div className="d-flex mb-3">
                    <div className="flex-shrink-0">
                      <img className="avatar avatar-circle" src="../assets/img/160x160/img5.jpg" alt="Image Description" />
                    </div>
                    <div className="flex-grow-1 ms-3">
                      <h5>Kurtis Blade</h5>
                      <div className="d-flex align-items-center mb-3">
                  ...
                  <div className="js-sticky-block" data-hs-sticky-block-options="{
                    ...
                    <div className="card card-bordered">
                      <div className="card-body">
                        ...
                        <img className="card-img-bottom" src="../assets/svg/illustrations/oc-chatting.svg" alt="Image Description" />
                      </div>
                    </div>
                    {/* End Card */}
                  </div>
          ...
          <div className="row mb-3">
            <div className="col-md-6 col-lg-4 mb-5">
              ...
              <div className="d-flex">
                <div className="flex-shrink-0">
                  <img className="avatar avatar-sm avatar-circle" src="../assets/img/160x160/img9.jpg" alt="Image Description" />
                </div>
                <div className="flex-grow-1 ms-3">
            ...
            <div className="col-md-6 col-lg-4 mb-5">
              ...
              <div className="d-flex">
                <div className="flex-shrink-0">
                  <img className="avatar avatar-sm avatar-circle" src="../assets/img/160x160/img1.jpg" alt="Image Description" />
                </div>
                <div className="flex-grow-1 ms-3">
                ...
                <div className="card-body">
                  <div className="row align-items-center">
                    <div className="col">
                      <div className="d-flex align-items-center">
                        <div className="flex-shrink-0">
                          <img className="avatar avatar-sm avatar-circle" src="../assets/img/480x320/img28.jpg" alt="SVG" />
                        </div>
                        <div className="flex-grow-1 ms-3">
                ...
                <div className="card-body">
                  <div className="row align-items-center">
                    <div className="col">
                      <div className="d-flex align-items-center">
                        <div className="flex-shrink-0">
                          <img className="avatar avatar-sm avatar-circle" src="../assets/img/480x320/img8.jpg" alt="SVG" />
                        </div>
                        <div className="flex-grow-1 ms-3">
                ...
                <div className="card-body">
                  <div className="row align-items-center">
                    <div className="col">
                      <div className="d-flex align-items-center">
                        <div className="flex-shrink-0">
                          <img className="avatar avatar-sm avatar-circle" src="../assets/img/480x320/img29.jpg" alt="SVG" />
                        </div>
                        <div className="flex-grow-1 ms-3">
                ...
                <div className="card-body">
                  <div className="row align-items-center">
                    <div className="col">
                      <div className="d-flex align-items-center">
                        <div className="flex-shrink-0">
                          <img className="avatar avatar-sm avatar-circle" src="../assets/img/480x320/img11.jpg" alt="SVG" />
                        </div>
                        <div className="flex-grow-1 ms-3">
                ...
                <div className="card-body">
                  <div className="row align-items-center">
                    <div className="col">
                      <div className="d-flex align-items-center">
                        <div className="flex-shrink-0">
                          <img className="avatar avatar-sm avatar-circle" src="../assets/img/480x320/img10.jpg" alt="SVG" />
                        </div>
                        <div className="flex-grow-1 ms-3">
                ...
                <div className="card-body">
                  <div className="row align-items-center">
                    <div className="col">
                      <div className="d-flex align-items-center">
                        <div className="flex-shrink-0">
                          <img className="avatar avatar-sm avatar-circle" src="../assets/img/480x320/img9.jpg" alt="SVG" />
                        </div>
                        <div className="flex-grow-1 ms-3">
