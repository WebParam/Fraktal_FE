      ...
      <div id = "form"  className="container content-space-3 content-space-t-lg-4 content-space-b-lg-3">
        <div className="flex-grow-1 mx-auto" style={{maxWidth: '28rem'}}>
          ...
          <div className="text-center mb-5 mb-md-7">
            ...
            <p className='login-text'>Login to manage your account.</p>
          </div>
          {/* End Heading */}
          {/* Form */}
          <form className="js-validate needs-validation" noValidate>
            ...
            <div className="mb-4">
              ...
              <input type="email" className="form-control form-control-lg" name="email" id="signupSimpleLoginEmail" placeholder="email@site.com" aria-label="email@site.com" required />
            ...
            <div className="mb-4">
              <div className="d-flex justify-content-between align-items-center">
                <label className="form-label" htmlFor="signupSimpleLoginPassword">Password</label>
                <a className="form-label-link" href="./page-reset-password-simple.html">Forgot Password?</a>
              </div>
              <div className="input-group input-group-merge" data-hs-validation-validate-class>
                <input type="password" className="js-toggle-password form-control form-control-lg" name="password" id="signupSimpleLoginPassword" placeholder="8+ characters required" aria-label="8+ characters required" required minLength={8} data-hs-toggle-password-options="{
            ...
            <div className="text-center">
              <p>Don't have an account yet? <a className="link" href="/auth/register">Sign up here</a></p>
            </div>
          </form>
          {/* End Form */}
        </div>
