...
<Header/>
  ...
  <main id="content" role="main">
    {/* Hero */}
    <div className="container overflow-hidden content-space-t-4">
      <div className="w-lg-75 text-center mx-lg-auto mb-9">
        <h1 className="display-3 mb-4">
          Build as frameworks from the ground up
        </h1>
        <p className="lead">
    ...
    {/* End Hero */}
    {/* Hero Image */}
    <div className="container-fluid content-space-b-2 content-space-b-lg-4">
    ...
    <div className="container d-none">
      ...
      <div className="row">
        <div className="col-sm-6 col-lg-4 mb-3 mb-lg-0" data-aos="fade-up">
          {/* Card */}
          <a
            className="js-go-to card card-transition h-100"
            href="#!"
            data-hs-go-to-options='{
        "targetSelector": "#docsSection",
        "offsetTop": 0,
        "position": null,
        "animationIn": false,
        "animationOut": false
          ...
          >
            <div className="p-2">
              <img
                className="card-img"
                src="./assets/svg/illustrations/docs-frame.svg"
                alt="Image Description"
              />
            </div>
            <div className="card-body">
              <h3 className="card-title text-inherit">Documentation</h3>
              <p className="card-text text-body">
                Discover how to build and maintain coding systems using our
                documentation.
              </p>
            </div>
        ...
        {/* End Col */}
        <div
          className="col-sm-6 col-lg-4 mb-3 mb-lg-0"
          data-aos="fade-up"
          data-aos-delay={150}
        >
          {/* Card */}
          <a
            ...
            href="#!"
            data-hs-go-to-options='{
        "targetSelector": "#snippetsSection",
        "offsetTop": 0,
        "position": null,
        "animationIn": false,
        "animationOut": false
          ...
          >
            <div className="p-2">
              <img
                className="card-img"
                src="./assets/svg/illustrations/snippets-frame.svg"
                alt="Image Description"
              />
            </div>
            <div className="card-body">
              <h3 className="card-title text-inherit">Snippets</h3>
              <p className="card-text text-body">
                Start browsing our snippets pages with copy-to-clipboard
                snippets to match Bootstrap's level of quality.
              </p>
            </div>
            <div className="card-footer pt-0">
              <span className="card-link">
                Start building <i className="bi-chevron-right small" />
              </span>
            </div>
          </a>
          {/* End Card */}
        ...
        >
          ...
          <a
            ...
            href="#!"
            data-hs-go-to-options='{
        "targetSelector": "#pageLayoutsSection",
        "offsetTop": 0,
        "position": null,
        "animationIn": false,
        "animationOut": false
          ...
          >
            <div className="p-2">
              <img
                className="card-img"
                src="./assets/svg/illustrations/layouts-frame.svg"
                alt="Image Description"
              />
            </div>
            <div className="card-body">
              <h3 className="card-title text-inherit">Page layouts</h3>
              <p className="card-text text-body">
                Apart from 70+ HTML-pages, the theme comes with 6 ready-to-use
                and stand-alone demo options.
              </p>
            </div>
            <div className="card-footer pt-0">
              <span className="card-link">
                View examples <i className="bi-chevron-right small" />
              </span>
            </div>
          </a>
          {/* End Card */}
    ...
    <div className="container">
      {/* Heading */}
      <div className="w-lg-75 text-center mx-md-auto mb-md-5">
        <h2 className="h1 lh-sm">
          Made for everyone, build anything with multiple pre-built demos
        </h2>
      </div>
      {/* End Heading */}
      {/* Main Demo */}
      <div className="row align-items-md-center content-space-2 content-space-b-lg-2">
          ...
          <figure className="device-browser">
            ...
            <div className="device-browser-frame">
              <img
                ...
                src="./assets/img/1618x1010/img7.jpg"
                alt="Image Description"
              />
            </div>
            <div className="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-primary zi-n1 mb-n6 ms-n6" />
          </figure>
          {/* End Browser Device */}
        </div>
        {/* End Col */}
        <div className="col-md-6">
          <div className="pe-md-7">
            <div className="mb-5">
              <div className="mb-5">
              ...
              <h2 className="mb-3">Main Demo</h2>
              <p className="fs-4">
                Front's main demo comes with 16 landing pages, including over 40
                commonly used pages that can be combined with another 6
                pre-built demos.
              </p>
            </div>
            <a
              ...
              href="./landing-classic-corporate.html"
            >
              Preview Main Demo <i className="bi-box-arrow-up-right ms-2" />
            </a>
          </div>
        </div>
        {/* End Col */}
        ...
        <div className="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure className="device-browser">
            ...
            <div className="device-browser-frame">
              <img
                className="device-browser-img"
                src="./assets/img/1618x1010/img9.jpg"
                alt="Image Description"
              />
            </div>
            <div className="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-danger zi-n1 mb-n6 ms-n6" />
          </figure>
          {/* End Browser Device */}
        </div>
        {/* End Col */}
        <div className="col-md-6">
          <div className="pe-md-7">
            <div className="mb-5">
              ...
              <h2 className="mb-3">E-Commerce Demo</h2>
              <p className="fs-4">
                Customize the appearance of products, lists, components, and
                snippets, but also cart, checkout, and other E-commerce pages.
              </p>
            </div>
            <a
              className="btn btn-primary"
              ...
              href="./demo-shop/index.html"
            >
              Preview Shop Demo <i className="bi-box-arrow-up-right ms-2" />
            </a>
          </div>
        </div>
        {/* End Col */}
      ...
      <div className="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div className="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure className="device-browser">
            ...
            <div className="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-success zi-n1 mb-n6 ms-n6" />
          </figure>
          {/* End Browser Device */}
        </div>
        {/* End Col */}
        <div className="col-md-6">
          <div className="pe-md-7">
            <div className="mb-5">
              ...
              <h2 className="mb-3">Jobs Demo</h2>
              <p className="fs-4">
                Demonstrate your job positions with more dynamic and interactive
                elements of Front to quickly put together a more professional
                looking page.
              </p>
            </div>
            <a
              ...
              href="./demo-jobs/index.html"
            >
              Preview Jobs Demo <i className="bi-box-arrow-up-right ms-2" />
            </a>
          </div>
        </div>
        {/* End Col */}
        ...
        <div className="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure className="device-browser">
            ...
            <div className="device-browser-frame">
              <img
                className="device-browser-img"
                src="./assets/img/1618x1010/img8.jpg"
                alt="Image Description"
              />
            </div>
            <div className="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-primary zi-n1 mb-n6 ms-n6" />
        ...
        <div className="col-md-6">
          <div className="pe-md-7">
            <div className="mb-5">
              ...
              <h2 className="mb-3">Real Estate Demo</h2>
              <p className="fs-4">
                Please your visitors with eye-catching and exciting real estate
                listings. Different options and settings to manage your site.
              </p>
            </div>
            <a
              className="btn btn-primary"
            ...
            >
              ...
              <i className="bi-box-arrow-up-right ms-2" />
            </a>
          </div>
        </div>
        {/* End Col */}
      </div>
      {/* End Real Estate Demo */}
      {/* Courses Demo */}
      <div className="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div className="col-md-6 order-md-2 mb-10 mb-md-0">
          {/* Browser Device */}
          <figure className="device-browser">
            ...
            <div className="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-info zi-n1 mb-n6 ms-n6" />
          </figure>
          {/* End Browser Device */}
        </div>
        {/* End Col */}
        <div className="col-md-6">
          <div className="pe-md-7">
            <div className="mb-5">
              ...
              <h2 className="mb-3">Courses Demo</h2>
              <p className="fs-4">
                Build a deep, solid understanding in education platform with
                Front Course demo. An online learning and teaching demo.
              </p>
            </div>
            <a
              className="btn btn-primary"
              ...
              href="./demo-course/index.html"
            >
              Preview Courses Demo <i className="bi-box-arrow-up-right ms-2" />
            </a>
          </div>
        </div>
        {/* End Col */}
      ...
      <div className="row align-items-md-center content-space-2 content-space-b-lg-2">
        <div className="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure className="device-browser">
            ...
            <div className="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-warning zi-n1 mb-n6 ms-n6" />
          </figure>
          {/* End Browser Device */}
        </div>
        {/* End Col */}
        <div className="col-md-6">
          <div className="pe-md-7">
            <div className="mb-5">
              ...
              <h2 className="mb-3">App Marketplace Demo</h2>
              <p className="fs-4">
                Create and run your online business with Front's App Marketplace
                demo. Easy to expand and designed to work together.
              </p>
            </div>
            <a
              className="btn btn-primary"
        ...
        <div className="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure className="device-browser">
            ...
            <div className="device-browser-frame">
              <img
                className="device-browser-img"
                src="./assets/img/1618x1010/img3.jpg"
                alt="Image Description"
              />
            </div>
            <div className="position-absolute bottom-0 start-0 w-100 h-100 bg-soft-secondary zi-n1 mb-n6 ms-n6" />
          </figure>
          {/* End Browser Device */}
        </div>
        {/* End Col */}
        <div className="col-md-6">
          <div className="pe-md-7">
            <div className="mb-5">
              ...
              <h2 className="mb-3">Help Desk</h2>
              <p className="fs-4">
                Find all the answers you are looking for in our extensive
                knowledge base demo option.
              </p>
            </div>
            <a
              className="btn btn-primary"
      ...
      <div className="container">
        <div className="bg-light p-4 p-sm-10">
          ...
          <div className="w-md-75 text-center mx-md-auto mb-5 mb-md-9">
            ...
            <a href="./documentation/index.html" className="btn btn-primary">
              Browse Documentation
            </a>
          </div>
          {/* End Heading */}
          <img
            className="img-fluid rounded-2 shadow-xl"
            src="./assets/svg/illustrations/docs-main-page.svg"
            alt="Image Description"
          />
        </div>
      </div>
    ...
    <div className="container content-space-t-2">
      <div className="p-4 p-sm-10">
        {/* Heading */}
        <div className="w-md-75 text-center mx-md-auto mb-5 mb-md-9">
          <h2>Snippets</h2>
          <p className="fs-4">
            Mix and match content and features from different demos. Copy-paste
            components that suit you the best. Combine features from different
            demos!
          </p>
          <a className="btn btn-primary" href="./snippets/index.html">
            Browse Snippets
          </a>
        </div>
        {/* End Heading */}
        <img
          className="img-fluid rounded-2 shadow-xl"
          src="./assets/svg/illustrations/snippets-main-page.svg"
          alt="Image Description"
        />
      </div>
    </div>
    ...
    <div className="position-relative gradient-y-gray">
      <div className="container content-space-2 content-space-b-sm-3 content-space-b-lg-4">
        {/* Heading */}
        <div className="w-md-75 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
        ...
        <div className="w-md-75 w-lg-50 mx-md-auto mb-5 mb-md-9">
          ...
          <div className="text-center mb-7">
            <p>
              ...
              compiled CSS and examples pages!{" "}
              <a className="link" href="./documentation/gulp.html">
                Learn more <i className="bi-chevron-right small" />
              </a>
            </p>
          </div>
          <div className="row justify-content-center">
            <div className="col-auto col-sm-3 col-sm py-3">
              <img
                ...
                src="./assets/svg/brands/bootstrap-gray.svg"
                alt="Logo"
              />
            </div>
            {/* End Col */}
            <div className="col-auto col-sm-3 col-sm py-3">
              <img
                className="avatar avatar-xl avatar-4x3"
                src="./assets/svg/brands/sass-gray.svg"
                alt="Logo"
              />
            </div>
            {/* End Col */}
            <div className="col-auto col-sm-3 col-sm py-3">
              <img
                className="avatar avatar-xl avatar-4x3"
                src="./assets/svg/brands/gulp-gray.svg"
                alt="Logo"
              />
            </div>
            {/* End Col */}
            <div className="col-auto col-sm-3 col-sm py-3">
              <img
                className="avatar avatar-xl avatar-4x3"
                src="./assets/svg/brands/npm-gray.svg"
                alt="Logo"
              />
            </div>
            {/* End Col */}
        ...
        <div className="d-grid mx-auto" style={{ maxWidth: "15rem" }}>
          <a
            className="btn btn-primary btn-transition"
            href="https://themes.getbootstrap.com/product/front-multipurpose-responsive-template/"
            target="_blank"
          >
            Get a license for $49
          </a>
        </div>
      </div>
      {/* Shape */}
        ...
        <div className="col-md-4">
          <div data-aos="fade-up">
            ...
            <div className="text-center px-md-3 px-lg-8">
              ...
              <p className="mb-0">
                Over <span className="text-dark fw-semibold">1k+</span> support
            ...
            <div className="text-center px-md-3 px-lg-8">
              <span className="svg-icon svg-icon-lg mb-3">
                ...
                >
                  ...
                  />
                  <path
                    d="M47.7294 21.1074H27.7266"
                    stroke="#21325B"
                    strokeWidth="1.98047"
                    strokeLinecap="round"
                  />
                  <path
                    d="M47.7294 27.9401H27.7266"
                    stroke="#21325B"
                    strokeWidth="1.98047"
                    strokeLinecap="round"
                  />
                  <path
                    d="M47.7294 34.7727H27.7266"
                    stroke="#21325B"
                    strokeWidth="1.98047"
                    strokeLinecap="round"
                  />
                  <path
                    d="M47.7294 41.9023H27.7266"
                    stroke="#21325B"
                    strokeWidth="1.98047"
                    strokeLinecap="round"
                  />
              ...
              <p className="mb-0">
                <span className="text-dark fw-semibold">5k+</span> Front copies
                have been purchased
              </p>
            </div>
            {/* End Stats */}
