...
//   const [otpVeriefied, setOtpverified] = useState<boolean>(false)
...
//      try {
//       const changePassword = await resetPassword({email:email, password:password, otp:""} as IUserResetPassword); // Rename the constant
//       if(changePassword){
