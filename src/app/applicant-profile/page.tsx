                  ...
                  <div className="col-lg mb-3 mb-lg-0">
                    ...
                    <ul className="list-inline list-separator">
                      <li className="list-inline-item">
                        <i className="bi-geo-alt-fill text-primary me-1" /> London, UK
                      </li>
              ...
              <div className="mb-8">
                ...
                <ul className="step step-icon-sm">
                  <li className="step-item">
                    <div className="step-content-wrapper">
                      <div className="step-avatar step-avatar-sm">
                        <img className="step-avatar-img" src="../assets/svg/brands/dropbox-icon.svg" alt="Image Description" />
                      </div>
                  ...
                  <li className="step-item">
                    <div className="step-content-wrapper">
                      <div className="step-avatar step-avatar-sm">
                        <img className="step-avatar-img" src="../assets/svg/brands/mailchimp-icon.svg" alt="Image Description" />
                      </div>
                      <div className="step-content">
                  ...
                  <li className="step-item">
                    <div className="step-content-wrapper">
                      <div className="step-avatar step-avatar-sm">
                        <img className="step-avatar-img" src="../assets/svg/brands/google-icon.svg" alt="Image Description" />
                      </div>
                      <div className="step-content">
              ...
              <div className="mb-8">
                ...
                <ul className="step step-icon-sm">
                  <li className="step-item">
                    <div className="step-content-wrapper">
                      <div className="step-avatar step-avatar-sm">
                        <img className="step-avatar-img" src="../assets/svg/brands/the-university-of-manchester.svg" alt="Image Description" />
                      </div>
                      <div className="step-content">
                    ...
                    <div className="card card-bordered">
                      <div className="card-body">
                        ...
                        <div className="d-grid mb-5">
                          <a className="btn btn-primary" href="#">Select a subscription</a>
                        </div>
