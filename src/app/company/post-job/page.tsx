                ...
                <div className="card-body">
                  ...
                  <div className="mb-4">
                    ...
                    <select
                      ...
                      name="countrySelect"
                      onChange={((e)=>{debugger; setType(e.target.value)})}
                    >    
                        {
                          typeOfProject.map(x=>{return(
                            <option selected={projectType==x.value} value={x.value}>{x.label}</option>
                          )})
                        }
                  ...
                  <div className="mb-4">
                    <label htmlFor="languageLabel" className="form-label">
                      What tech stack is/will the project utlize?
                    </label>
                  ...
                  <div className="mb-4">
                    ...
                    <select
                      ...
                      className="form-select"
                      name="countrySelect"
                      onChange={((e)=>{ debugger; setTeam(e.target.value)})}
                    >    
                    {
                          projectTeams.map(x=>{return(
                            <option selected={projectTeam==x.value} value={x.value}>{x.label}</option>
                          )})
                        }
                    </select>
                ...
                <div className="card-body">
                      ...
                      <label className="form-control" htmlFor="jobTypeRadio1">
                        <span className="form-check custom-radio">
                          <input
                            ...
                            id="jobTypeRadio1"
                            defaultChecked={true}
                            onChange={()=>handleJobTypeChange(0)}
                            checked={jobType==0}
                          />
                          <span className="form-check-label">Full time contract position/s</span>
                        </span>
                      </label>
                      {/* End Custom Radio */}
                      {/* Custom Radio */}
                      <label className="form-control" htmlFor="jobTypeRadio2">
                        <span className="form-check custom-radio">
                          <input
                            ...
                            name="jobTypeRadioName"
                            id="jobTypeRadio2"
                            onChange={()=>handleJobTypeChange(1)}
                            checked={jobType==1}
                          />
                          <span className="form-check-label">Part time contract position/s</span>
                        </span>
                      </label>
                      {/* End Custom Radio */}
                      {/* Custom Radio */}
                      <label className="form-control" htmlFor="jobTypeRadio3">
                        <span className="form-check custom-radio">
                          <input
                            ...
                            name="jobTypeRadioName"
                            id="jobTypeRadio3"
                            onChange={()=>handleJobTypeChange(2)}
                            checked={jobType==2}
                          />
                          <span className="form-check-label">Open ended contract position/s</span>
                        </span>
                      </label>
                      {/* End Custom Radio */}
                      {/* Custom Radio */}
                      ...
                      <label className="form-control" htmlFor="jobTypeRadio5">
                        <span className="form-check custom-radio">
                          <input
                            ...
                            name="jobTypeRadioName"
                            id="jobTypeRadio5"
                            onChange={()=>handleJobTypeChange(3)}
                            checked={jobType==3}
                          />
                      ...
                      <label className="form-control" htmlFor="jobTypeRadio6">
                        <span className="form-check custom-radio">
                          <input
                            ...
                            name="jobTypeRadioName"
                            id="jobTypeRadio6"
                            onChange={()=>handleJobTypeChange(4)}
                            checked={jobType==4}
                          />
                          <span className="form-check-label">
                            Other
                  ...
                  <div className="mb-4">
                    <label htmlFor="numberOfHiresLabel" className="form-label">
                      How many hires do you want to make for this project?
                    </label>
                    <p className="small mt-n2">
                  ...
                  <div className="mb-4">
                    ...
                    >
                      ...
                      <option value={1} selected={urgency==1}>3 to 7 days</option>
                      <option value={2} selected={urgency==2}>1 to 2 weeks</option>
                      <option value={3} selected={urgency==3}>2 to 4 weeks</option>
                      <option value={4} selected={urgency==4}>
                        More than 4 weeks
                      </option>
                    </select>
                    {/* End Select */}
              ...
              <div
                ...
                >
                  <div className="flex-grow-1">
                    ...
                    <h3 className="card-header-title">What's the budget?</h3>
                    <p className="card-text">
                ...
                <div className="card-body">
                  <div className="row gx-3">
                    ...
                    {/* End Col */}
                    <div className="mb-4 col-6 col-sm-6">
                      ...
                      <div className="mb-4">
                        ...
                        >
                          ...
                          <option value={0} selected={period==1}>per developer</option>
                          <option value={1} selected={period==2}>total per month</option>
                          <option value={2} selected={period==3}>for the whole project</option>
                  ...
                  <ul className="list-unstyled list-py-3">
                    <li className="border-bottom">
                      <div className="row">
                        <div className="col-sm-8 mb-3 mb-sm-0">
                          <h5>Is there a development team currently working on the project? {projectTeam}</h5>
                          <span className="d-block">{getLabelFromValue(projectTeam,projectTeams)}</span>
                        </div>
                      </div>
                      {/* End Row */}
                    </li>
                    ...
                    <li className="border-bottom">
                      <div className="row">
                        <div className="col-sm-8 mb-3 mb-sm-0">
                          <h5>Tech stack</h5>
                          <span className="d-block">{getOptionFromValue([language],techStack)[0]?.label}</span>
                        </div>
                        {/* End Col */}
                        <div className="col-sm-4">
                          <div className="d-sm-flex justify-content-sm-end">
